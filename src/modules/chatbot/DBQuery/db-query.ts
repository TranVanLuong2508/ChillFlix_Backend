export const BackenDBQuery = {
  ...
  filmGenreFullData: `
    SELECT 
      ...
      "FilmGenre__FilmGenre_film"."createdBy",
      "FilmGenre__FilmGenre_film"."updatedBy",
      "FilmGenre__FilmGenre_film"."deletedBy",
  ...
  film_by_actor: `
    ...
    "FilmActor__FilmActor_film"."createdBy" AS "FilmActor__FilmActor_film_createdBy",
    "FilmActor__FilmActor_film"."updatedBy" AS "FilmActor__FilmActor_film_updatedBy",
    "FilmActor__FilmActor_film"."deletedBy" AS "FilmActor__FilmActor_film_deletedBy",
  ...
  film_by_director: `
    ...
    "FilmDirector__FilmDirector_film"."createdBy" AS "FilmDirector__FilmDirector_film_createdBy",
    "FilmDirector__FilmDirector_film"."updatedBy" AS "FilmDirector__FilmDirector_film_updatedBy",
    "FilmDirector__FilmDirector_film"."deletedBy" AS "FilmDirector__FilmDirector_film_deletedBy",
